...
public final class FirstUniqueName {
    ...
    public static void run() throws IOException {
        ...
        resultList.add(FirstUniqueName.findFirstUniqueName((MyUtils.readingFileByWords(FirstUniqueName.FILE_READ_NAME))) + "  <-It is you result");
        System.out.println(resultList);
        MyUtils.writeInFile(FirstUniqueName.FILE_WRITE_NAME, resultList);
    }

    private static String findFirstUniqueName(List<String> listInputs) {
